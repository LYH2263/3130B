...
export function TeacherDashboard({ user, token, onLogout, onNavigateToSubjective, onNavigateToGrading, onNavigateToExam, onNavigateToReport, onNavigateToProctor }) {
